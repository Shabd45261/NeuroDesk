...
### 3.5 Recommended path for NeuroDesk
...
2. **Ginkgo/Gomega seeded property tests** — the Go-native floor. A small Go model
   ...
   automatic shrinking, but NeuroDesk mandates Ginkgo/Gomega for all tests — its
...
- **Go-native layer:** **Ginkgo/Gomega seeded property tests** run alongside — they
  ...
  (Originally specced as `rapid`; switched to Ginkgo/Gomega to satisfy NeuroDesk's
