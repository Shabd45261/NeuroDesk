...
Editing a model configuration in a distributed NeuroDesk deployment can leave the
...
therefore cannot continue receiving inference traffic through NeuroDesk even if
