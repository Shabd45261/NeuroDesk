...
This document provides guidance for AI tools and developers using AI assistance when contributing to NeuroDesk.

**NeuroDesk follows the same guidelines as the Linux kernel project for AI-assisted contributions.** See the upstream policy here: <https://docs.kernel.org/process/coding-assistants.html>. The rules below mirror that policy, adapted to NeuroDesk's license and project layout.

AI tools helping with NeuroDesk development should follow the standard project development process:

- [CONTRIBUTING.md](https://github.com/mudler/NeuroDesk/blob/master/CONTRIBUTING.md) - development workflow, commit conventions, and PR guidelines
- [AGENTS.md](https://github.com/mudler/NeuroDesk/blob/master/AGENTS.md) - the agent entry point with links to all detailed topic guides
- [.agents/ai-coding-assistants.md](https://github.com/mudler/NeuroDesk/blob/master/.agents/ai-coding-assistants.md) - the full policy source of truth

## Licensing and Legal Requirements

All contributions must comply with NeuroDesk's licensing requirements:

- NeuroDesk is licensed under the **MIT License**
...
- It applies only to automation a NeuroDesk maintainer operates and whose output that maintainer reviews before merge.
...
When AI tools contribute to NeuroDesk development, proper attribution helps track the evolving role of AI in the development process. Contributions should include an `Assisted-by` tag in the commit message trailer in the following format:
