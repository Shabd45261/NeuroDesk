...
This section collects the operator-facing concerns for running NeuroDesk in production: request middleware, cloud and MITM proxies, and backend monitoring. These pages are about running and governing a NeuroDesk instance rather than about a specific inference feature.
...
- [MITM proxy for Claude Code / Codex CLI]({{% relref "operations/mitm-proxy" %}}) - redact PII from cloud-AI traffic without NeuroDesk holding API keys.
