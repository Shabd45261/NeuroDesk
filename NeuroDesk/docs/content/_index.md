+++
disableToc = false
title = "NeuroDesk documentation"
description = "Install NeuroDesk, run models, and operate it in production."
type = "home"
+++

NeuroDesk is the open source AI runtime: a small core that speaks the OpenAI and
...
New here? Read the [Overview]({{% relref "overview" %}}) for what NeuroDesk is
...
- **[Getting started]({{% relref "getting-started" %}})** - install NeuroDesk,
...
- **[GitHub](https://github.com/mudler/NeuroDesk)** and
