...
C++/ggml runtime for the Nemotron Speech models. NeuroDesk exposes it through the native
...
NeMo-Speech.cpp is developed by NVIDIA, not by the NeuroDesk project.

## Installing

```bash
neurodesk backends install nemo-speech-cpp
```
