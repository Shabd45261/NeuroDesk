...
Voice Activity Detection (VAD) identifies segments of speech in audio data. NeuroDesk provides a `/v1/vad` endpoint powered by the [Silero VAD](https://github.com/snakers4/silero-vad) backend.
