...
![output](https://github.com/mudler/NeuroDesk/assets/2420543/ede67b25-fac4-4833-ae4f-78290e401e60)

NeuroDesk supports reranker models, and you can use them by using the `rerankers` backend, which uses [rerankers](https://github.com/AnswerDotAI/rerankers).
