...
NeuroDesk supports understanding images by using [LLaVA](https://llava.hliu.cc/), and implements the [GPT Vision API](https://platform.openai.com/docs/guides/vision) from OpenAI.

![llava](https://github.com/mudler/NeuroDesk/assets/2420543/cb0a0897-3b58-4350-af66-e6f4387b58d3)
...
```bash
neurodesk run moondream2-20250414
```

To let NeuroDesk understand and reply with what sees in the image, use the `/v1/chat/completions` endpoint, for example with curl:
