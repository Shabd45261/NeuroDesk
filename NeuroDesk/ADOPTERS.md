...
Organisations running NeuroDesk, listed by the people who run it.

If your organisation uses NeuroDesk and you are happy to say so publicly, open a
...
3. Say briefly what you use NeuroDesk for, and whether it is in production.
...
- **These projects integrate NeuroDesk.** Evidence is a reference to NeuroDesk in
