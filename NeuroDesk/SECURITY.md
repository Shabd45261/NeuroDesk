...
At NeuroDesk, we take the security of our software seriously. We understand the importance of protecting our community from vulnerabilities and are committed to ensuring the safety and security of our users.
...
- **From 1.x to 3.x:** Version 1.x reached end-of-life on January 1, 2024. Review the [release notes](https://github.com/mudler/NeuroDesk/releases) for breaking changes across major versions, and upgrade directly to the latest 3.x release.
...
We appreciate the efforts of those who contribute to the security of our project. Your responsible disclosure is invaluable to the safety and integrity of NeuroDesk.

Thank you for helping us keep NeuroDesk secure.
