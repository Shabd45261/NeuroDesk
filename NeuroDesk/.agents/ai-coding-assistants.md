...
assistance when contributing to NeuroDesk.

**NeuroDesk follows the same guidelines as the Linux kernel project for
AI-assisted contributions.** See the upstream policy here:
<https://docs.kernel.org/process/coding-assistants.html>

The rules below mirror that policy, adapted to NeuroDesk's license and
project layout. If anything is unclear, the kernel document is the
authoritative reference for intent.

AI tools helping with NeuroDesk development should follow the standard
...
- NeuroDesk is licensed under the **MIT License** — see the [LICENSE](../LICENSE)
  file
...
- It applies only to automation a NeuroDesk maintainer operates and whose
...
When AI tools contribute to NeuroDesk development, proper attribution helps
