---
title: "NeuroDesk 4.1: more than one box, and more than one user"
date: 2026-04-02
...
Two problems show up the moment NeuroDesk stops being a thing you run for yourself.
...
NeuroDesk ships a multi-user platform now, which is the piece that makes it deployable for a team or a classroom rather than just for you.
...
Fine-tuning uses HuggingFace TRL to train LoRA adapters, exports the result to GGUF automatically, and imports it back into NeuroDesk so you can serve what you just trained without moving files around by hand. There is a small evals framework included to check whether the thing you trained is actually better.
...
```sh
neurodesk agent run <name>
neurodesk agent list
```
...
[Full release notes](https://github.com/mudler/NeuroDesk/releases/tag/v4.1.0).
