(function(){
  ...
  (function(){
    ...
    function render(ms){
      ...
      var head=document.getElementById('neurodesk'), eng=document.getElementById('engines');
  ...
  var CMD = {'p-script':'curl -sSL https://localai.io/install.sh | sh',
             'p-docker':'docker run -p 8080:8080 --name neurodesk -ti neurodesk/neurodesk:latest',
