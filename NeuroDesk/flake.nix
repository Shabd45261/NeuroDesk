# Made by Azteczek
{
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      neurodesk-unwrapped = pkgs.buildGoModule {
        pname = "neurodesk";
        version = "custom";
 	...
 	src = ./.;
        ...
        preBuild = ''
          ...
          go mod edit -replace github.com/mudler/NeuroDesk/pkg/grpc/proto=./pkg/grpc/proto
	...
	'';
        ...
        subPackages = [ "cmd/neurodesk" ];
        doCheck = false;

        postInstall = ''
          [ -f $out/bin/neurodesk ] && mv $out/bin/neurodesk $out/bin/neurodesk
        '';
      };
    in {
      packages.${system} = {
        neurodesk-unwrapped = neurodesk-unwrapped;
        ...
        default = pkgs.buildFHSEnv {
          ...
          runScript = "${neurodesk-unwrapped}/bin/neurodesk";
        };
      };
      ...
      devShells.${system}.default = pkgs.mkShell {
        ...
        shellHook = ''
          ...
          echo "NeuroDesk dev shell: $(go version), node $(node --version)"
