...
import (
	...
	"github.com/mudler/NeuroDesk/core/services/storage"
	coreStartup "github.com/mudler/NeuroDesk/core/startup"
...
func New(opts ...config.AppOption) (*Application, error) {
	...
	xlog.Info("Starting NeuroDesk", "threads", options.Threads, "modelsPath", options.SystemState.Model.ModelsPath)
	xlog.Info("NeuroDesk version", "version", internal.PrintableVersion())
	...
	// counter is created. monitoring.NewNeuroDeskMetricsService calls
	...
	if !options.DisableMetrics {
		ms, err := monitoring.NewNeuroDeskMetricsService()
		if err != nil {
