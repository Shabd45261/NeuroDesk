...
var _ = Describe("LLM tests", func() {
	...
	Context("ToProtoMessages conversion", func() {
		...
		// Regression for mudler/NeuroDesk#10524: a text part whose inner text is
		...
		It("should not leak unset NeuroDesk-only or cross-endpoint request fields into JSON", func() {
		...
		// Regression for mudler/NeuroDesk#10039: ToProto is the path taken by
