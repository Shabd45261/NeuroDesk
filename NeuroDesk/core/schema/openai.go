...
import (
	...
	functions "github.com/mudler/NeuroDesk/pkg/functions"
)
...
type OpenAIRequest struct {
	...
	// NeuroDesk-specific request fields below. They carry server-side
...
// served by the NeuroDesk-specific /v1/models/capabilities endpoint so clients can
