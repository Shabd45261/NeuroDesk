...
var _ = Describe("OllamaEmbedRequest", func() {
	...
	Context("JSON unmarshaling (Ollama API compatibility)", func() {
		...
		// NeuroDesk must accept `prompt` so client libraries using that key are not broken.
		// See https://github.com/mudler/NeuroDesk/issues/9767.
...
// https://github.com/mudler/NeuroDesk/issues/9837.
