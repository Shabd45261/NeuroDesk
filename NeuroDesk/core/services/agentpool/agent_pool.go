...
import (
	...
	skillsManager "github.com/mudler/NeuroDesk/core/services/skills"
...
// to provide agentic capabilities integrated directly into NeuroDesk.
...
func (s *AgentPoolService) Start(ctx context.Context) error {
	...
	// API URL: use configured value, or derive self-referencing URL from NeuroDesk's address
	apiURL := cfg.APIURL
	if apiURL == "" {
...
// is auto-generated so the agent can authenticate against NeuroDesk's own API.
