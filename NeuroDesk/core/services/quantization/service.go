...
import (
	...
	"github.com/mudler/NeuroDesk/core/services/syncstate"
...
// ImportModel imports a quantized model into NeuroDesk asynchronously.
func (s *QuantizationService) ImportModel(ctx context.Context, userID, jobID string, req schema.QuantizationImportRequest) (string, error) {
	...
	go func() {
		...
		s.setImportMessage(job, "Registering model with NeuroDesk...")
