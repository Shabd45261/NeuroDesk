...
import (
	...
	"github.com/mudler/NeuroDesk/core/services/routing/contract"
...
var (
	...
	// monitoring.NeuroDeskMetricsService). Setting it before initMetrics
...
// SetMeter wires the meter from monitoring.NeuroDeskMetricsService (or any
...
func resolveMeter() metric.Meter {
	...
	return otel.Meter("github.com/mudler/NeuroDesk/core/services/routing/billing")
}
...
func initMetrics() {
	metricsOnce.Do(func() {
		...
		sharedRequestsCount, err = meter.Int64Counter(
			"neurodesk_billed_requests_total",
		...
		sharedUnrecordedCounter, err = meter.Int64Counter(
			"neurodesk_usage_unrecorded_total",
...
// CountUnrecorded ticks the neurodesk_usage_unrecorded_total counter so that
