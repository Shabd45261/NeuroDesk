...
func init() {
	meter := otel.Meter("github.com/mudler/NeuroDesk/core/services/routing")
	c, err := meter.Int64Counter(
		"neurodesk_invariant_violation_total",
...
// and increments neurodesk_invariant_violation_total{name=name}. Use
