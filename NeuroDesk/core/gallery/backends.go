// Package gallery provides installation and registration utilities for NeuroDesk backends,
...
func DeleteBackendFromSystem(systemState *system.SystemState, name string) error {
	...
	if !ok {
		...
		// The UI may send gallery-style names like "neurodesk@llama-cpp" which
