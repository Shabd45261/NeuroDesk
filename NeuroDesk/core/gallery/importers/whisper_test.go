...
var _ = Describe("WhisperImporter", func() {
	...
	Context("real-world multi-quant repo: NeuroDesk-io/whisper-large-v3-it-yodas-only-ggml", func() {
		const (
			uri  = "https://huggingface.co/NeuroDesk-io/whisper-large-v3-it-yodas-only-ggml"
