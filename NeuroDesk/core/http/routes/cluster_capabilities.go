...
func ClusterCapabilityProviderFor(app *application.Application) neurodesk.ClusterCapabilityProvider {
...
func ClusterInstalledProviderFor(app *application.Application) neurodesk.ClusterInstalledProvider {
