...
import (
	...
	neurodesk "github.com/mudler/NeuroDesk/core/http/endpoints/neurodesk"
	mcpTools "github.com/mudler/NeuroDesk/core/http/endpoints/mcp"
	"github.com/mudler/NeuroDesk/core/http/endpoints/openresponses"
...
func RegisterOpenResponsesRoutes(app *echo.Echo,
	...
	responsesMiddleware := []echo.MiddlewareFunc{
		...
		neurodesk.AgentResponsesInterceptor(application),
		...
		re.SetModelAndConfig(func() schema.NeuroDeskRequest { return new(schema.OpenResponsesRequest) }),
