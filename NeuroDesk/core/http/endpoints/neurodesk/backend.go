...
// DeleteBackendEndpoint lets delete backends from a NeuroDesk instance
// @Summary delete backends from NeuroDesk.
// @Tags backends
...
// ListBackendsEndpoint list the available backends configured in NeuroDesk
...
// ListBackendGalleriesEndpoint lists the available backend galleries configured in NeuroDesk.
...
// ListAvailableBackendsEndpoint list the available backends in the galleries configured in NeuroDesk
...
// backend that is not yet installed so NeuroDesk can auto-install it.
