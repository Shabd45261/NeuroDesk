...
type GalleryModel struct {
	...
	// NeuroDesk auto-select the largest build this host can actually run.
...
// ApplyModelGalleryEndpoint installs a new model to a NeuroDesk instance from the model gallery
// @Summary Install models to NeuroDesk.
// @Tags models
...
// DeleteModelGalleryEndpoint lets delete models from a NeuroDesk instance
// @Summary delete models to NeuroDesk.
// @Tags models
...
// ListModelGalleriesEndpoint list the available galleries configured in NeuroDesk
