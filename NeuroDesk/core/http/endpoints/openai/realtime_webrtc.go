...
type RealtimeCallRequest struct {
	...
	// NeuroDeskAssistant opts the session into the in-process admin tool
	...
	NeuroDeskAssistant bool `json:"neurodesk_assistant,omitempty"`
}
...
func decodeRealtimeCallRequest(c echo.Context) (RealtimeCallRequest, bool, error) {
	...
	case echo.MIMEMultipartForm:
		...
		req.NeuroDeskAssistant = session.NeuroDeskAssistant
		return req, true, nil
...
func RealtimeCalls(application *application.Application) echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		...
		opts := RealtimeSessionOptions{
			NeuroDeskAssistant: req.NeuroDeskAssistant,
