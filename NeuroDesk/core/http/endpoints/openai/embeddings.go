...
// NeuroDesk extensions: a chat conversation can be embedded by sending
...
func EmbeddingsEndpoint(cl *config.ModelConfigLoader, ml *model.ModelLoader, evaluator *templates.Evaluator, appConfig *config.ApplicationConfig) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		// NeuroDesk's embeddings endpoint does not currently track per-call
		...
		// neurodesk_billed_requests_total counter; without this the call
