...
const (
	...
	// ServerEventTypeConversationItemSpeaker is a NeuroDesk extension: it reports
	...
	// ServerEventTypeClassifierResult is a NeuroDesk extension: it carries the
	// classifier-mode score distribution and decision for a response. OpenAI
	// clients ignore it.
	ServerEventTypeClassifierResult                   ServerEventType = "neurodesk.classifier.result"
...
// item. NeuroDesk extension; not part of the OpenAI Realtime API.
...
// sound-event-detection model. This is a NeuroDesk extension to the OpenAI
