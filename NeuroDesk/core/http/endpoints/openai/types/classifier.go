...
// ClassifierConfig is a NeuroDesk extension to the Realtime API
// (session.neurodesk_classifier, response.neurodesk_classifier): instead of
...
// ClassifierResultEvent is a NeuroDesk extension server event
// (neurodesk.classifier.result) emitted once per classifier-handled response
