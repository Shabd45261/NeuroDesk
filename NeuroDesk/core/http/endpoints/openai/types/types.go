...
type RealtimeSession struct {
	...
	// NeuroDeskClassifier is a NeuroDesk extension: prefill-scored option
	// selection instead of autoregressive generation. Replaced wholesale
	// on update, like tools. OpenAI clients simply never set it.
	NeuroDeskClassifier *ClassifierConfig `json:"neurodesk_classifier,omitempty"`
}
...
type ResponseCreateParams struct {
	...
	// NeuroDeskClassifier is a NeuroDesk extension: when non-nil it replaces
