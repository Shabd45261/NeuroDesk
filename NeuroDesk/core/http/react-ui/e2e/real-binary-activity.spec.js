...
// Runs against a REAL neurodesk binary with NO route stubbing.
//
...
//
//   make build
//   ./neurodesk run --address 127.0.0.1:8089 --models-path /tmp/lai-e2e
//   cd core/http/react-ui
//   NEURODESK_REAL_BINARY=1 PLAYWRIGHT_EXTERNAL_SERVER=1 PW_WORKERS=1 \
//     npx playwright test e2e/real-binary-activity.spec.js
//
// Skipped by default so CI, which runs the stub server, is unaffected.
test.skip(!process.env.NEURODESK_REAL_BINARY, 'needs a real neurodesk on 127.0.0.1:8089')
