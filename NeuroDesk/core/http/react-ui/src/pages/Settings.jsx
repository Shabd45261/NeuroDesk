      ...
      <div className="set-layout">
        ...
        >
          ...
          <div ref={el => sectionRefs.current.branding = el} className="mb-xl">
            ...
            <div className="card">
              <SettingRow label="Instance Name" description="Replaces &quot;NeuroDesk&quot; in the sidebar, footer, and browser tab. Visible on the login screen.">
                <input
                  className="input col-w-240"
                  value={settings.instance_name || ''}
                  onChange={(e) => update('instance_name', e.target.value)}
                  placeholder="NeuroDesk"
                />
              </SettingRow>
          ...
          <div ref={el => sectionRefs.current.galleries = el} className="mb-xl">
            ...
            <div className="card">
              <SettingRow label="Load and pre-warm galleries on boot" description="Load model galleries and pre-warm their remote size and VRAM estimates when NeuroDesk starts">
          ...
          <div ref={el => sectionRefs.current.assistant = el} className="mb-xl">
            <h3 className="panel-title">
              <i className="fas fa-user-shield text-accent" /> NeuroDesk Assistant
            </h3>
            <div className="card">
              <SettingRow label="Enabled" description="Allow admins to opt chat sessions into the in-process admin tool surface. Disabling refuses new requests with the neurodesk_assistant flag; takes effect without restart.">
                <Toggle checked={settings.neurodesk_assistant_enabled ?? true} onChange={(v) => update('neurodesk_assistant_enabled', v)} />
              </SettingRow>
            </div>
          </div>
