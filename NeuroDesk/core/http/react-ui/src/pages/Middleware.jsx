    ...
    <div className="stack">
      ...
      <div className="card pad-lg">
        ...
        {mitm.ca_available ? (
          <a
            ...
            download="neurodesk-mitm-ca.crt"
          >
      ...
      <div className="card pad-md bg-secondary">
        ...
        <ol className="mw-list text-sub">
          ...
          <li>Trust it on the client. For Node-based CLIs (Claude Code, Codex): <code className="text-mono">export NODE_EXTRA_CA_CERTS=$(pwd)/neurodesk-mitm-ca.crt</code></li>
