...
const ENROLL_KEY = 'neurodesk_face_enrollments'
    ...
    <div className="biometrics-page">
      <header className="biometrics-page__header">
        <div>
          ...
          <p className="page-subtitle">Compare, identify, and analyze faces using any face model installed on this NeuroDesk instance. Samples never leave your machine — they go only to the running backend.</p>
        </div>
      ...
      <section className="biometrics-results">
        ...
        {!loading && !error && !result && (
          <EmptyState icon="fas fa-code"
            ...
            body="For developers — retrieve the raw vector for a face to store, search, or cluster outside of NeuroDesk." />
        )}
        {result && (
