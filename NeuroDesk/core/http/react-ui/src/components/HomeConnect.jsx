...
// NeuroDesk's own API goes well beyond chat — a sample of capability endpoints
...
export default function HomeConnect() {
  ...
  const [dismissed, setDismissed] = useState(() => {
    try { return localStorage.getItem('neurodesk_home_connect_dismissed') === '1' } catch { return false }
  })
  ...
  const dismiss = () => {
    try { localStorage.setItem('neurodesk_home_connect_dismissed', '1') } catch { /* ignore */ }
    setDismissed(true)
  }
