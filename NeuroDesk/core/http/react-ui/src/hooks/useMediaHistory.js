...
const STORAGE_KEYS = {
  image: 'neurodesk_image_history',
  video: 'neurodesk_video_history',
  tts: 'neurodesk_tts_history',
  sound: 'neurodesk_sound_history',
  'audio-transform': 'neurodesk_audio_transform_history',
}
