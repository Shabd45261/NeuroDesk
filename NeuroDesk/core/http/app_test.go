...
var _ = Describe("API test", func() {
	...
	var tmpdir string
	var modelDir string
	// neuroDeskApp captures the Application so AfterEach can synchronously
	...
	var neuroDeskApp *application.Application
	...
	Context("API with ephemeral models", func() {
		...
		Context("URL routing Tests", func() {
			...
			// prefix before forwarding upstream, so NeuroDesk receives the
...
`
			...
			neuroDeskApp, err = application.New(
				append(commonOpts,
					config.WithContext(c),
					config.WithSystemState(systemState),
				)...)
