...
const (
	...
	FeatureNeuroDeskAssistant = "neurodesk_assistant"
...
var AgentFeatures = []string{FeatureAgents, FeatureSkills, FeatureCollections, FeatureMCPJobs, FeatureNeuroDeskAssistant}
