...
// NEURODESK_REQUIRE_BACKEND_INTEGRITY is unset; that flag turns the warning
// into a hard error).
//
...
//	  identity_regex: "^https://github\\.com/mudler/neurodesk-backends/\\.github/workflows/build\\.yaml@refs/heads/master$"
