...
// an option-less `neurodesk run` gets. cmd/neurodesk feeds them to kong as
...
const DefaultGalleriesJSON = `[{"name":"neurodesk", "url":"https://index.localai.io/models", "mirrors":["github:mudler/NeuroDesk/gallery/index.yaml@master"]}]`
const DefaultBackendGalleriesJSON = `[{"name":"neurodesk", "url":"https://index.localai.io/backends", "mirrors":["github:mudler/NeuroDesk/backend/index.yaml@master"]}]`
...
// DefaultRuntimeBaseline is the ApplicationConfig an option-less `neurodesk
