...
// validates its structure, remaps field names to NeuroDesk conventions,
...
// neuroDeskDefaults is our output structure
type neuroDeskDefaults struct {
	Comment  string                        `json:"_comment"`
	Families map[string]map[string]float64 `json:"families"`
	Patterns []string                      `json:"patterns"`
}
...
// fieldRemap maps unsloth field names to NeuroDesk field names
...
func marshalOrdered(d neuroDeskDefaults) ([]byte, error) {
