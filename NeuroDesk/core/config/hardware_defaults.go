...
// NEURODESK_DISABLE_HARDWARE_DEFAULTS=true (mirrors NEURODESK_DISABLE_GUESSING). When
...
func HardwareDefaultsDisabled() bool {
	// Read directly like the sibling NEURODESK_DISABLE_GUESSING toggle in
	...
	//nolint:forbidigo // config-layer heuristic toggle, mirrors NEURODESK_DISABLE_GUESSING
	return os.Getenv("NEURODESK_DISABLE_HARDWARE_DEFAULTS") == "true"
}
