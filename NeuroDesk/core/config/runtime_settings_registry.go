...
var runtimeSettingsFields = []fieldSpec{
	...
	// NeuroDesk Assistant: stored as the negation for UI clarity.
	field("neurodesk_assistant_enabled",
		func(s *RuntimeSettings) **bool { return &s.NeuroDeskAssistantEnabled },
		func(o *ApplicationConfig) bool { return !o.DisableNeuroDeskAssistant },
		func(o *ApplicationConfig, v bool) { o.DisableNeuroDeskAssistant = !v }),
