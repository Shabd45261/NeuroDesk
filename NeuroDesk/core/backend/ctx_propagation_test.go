...
// Regression spec for X-NeuroDesk-Node coverage on audio/image/TTS/rerank/VAD.
//
// The X-NeuroDesk-Node middleware (core/http/middleware.ExposeNodeHeader)
...
import (
	...
	pbproto "github.com/mudler/NeuroDesk/pkg/grpc/proto"
...
var _ = Describe("X-NeuroDesk-Node ctx propagation contract", func() {
