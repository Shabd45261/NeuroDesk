...
func (t *TranscriptCMD) Run(ctx *cliContext.Context) error {
	...
	if !exists {
		return fmt.Errorf("model %q not found. Run 'neurodesk models list' to see available models, or install one with 'neurodesk models install <model>'. See https://localai.io/models/ for more information", t.Model)
	}
