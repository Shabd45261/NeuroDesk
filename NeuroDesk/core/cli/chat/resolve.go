...
//
// Available is used exactly as the server gave it. NeuroDesk advertises stray
...
func ResolveModel(req ModelRequest) (string, error) {
	...
	case 0:
		return "", errors.New("the NeuroDesk server has no models installed. Install one with 'neurodesk models install <name>', then run 'neurodesk chat' again")
	case 1:
