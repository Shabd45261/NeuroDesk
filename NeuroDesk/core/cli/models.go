...
import (
	...
	"github.com/mudler/NeuroDesk/core/startup"
	"github.com/mudler/NeuroDesk/pkg/downloader"
...
type ModelsCMDFlags struct {
	...
	BackendsPath     string `env:"NEURODESK_BACKENDS_PATH,BACKENDS_PATH" type:"path" default:"${basepath}/backends" help:"Path containing backends used for inferencing" group:"storage"`
...
type ModelsInstall struct {
	...
	AutoloadBackendGalleries bool     `env:"NEURODESK_AUTOLOAD_BACKEND_GALLERIES" help:"If true, automatically loads backend galleries" group:"backends" default:"true"`
	ModelArgs                []string `arg:"" optional:"" name:"models" help:"Model configuration URLs to load"`
	Variant                  string   `name:"variant" help:"Install a specific variant of a gallery entry that declares them, by the variant's model name. Leave unset to let NeuroDesk auto-select: builds this hardware cannot run or cannot fit are dropped, the engine this hardware prefers wins, and size decides among equals." group:"models"`
