...
type AgentCMD struct {
	Run  AgentRunCMD  `cmd:"" help:"Run an agent standalone (without the full NeuroDesk server)"`
...
type AgentRunCMD struct {
	...
	APIURL                string `env:"NEURODESK_AGENT_POOL_API_URL" help:"API URL for the agent to call (e.g. http://127.0.0.1:8080)" group:"agents"`
	APIKey                string `env:"NEURODESK_AGENT_POOL_API_KEY" help:"API key for the agent" group:"agents"`
	DefaultModel          string `env:"NEURODESK_AGENT_POOL_DEFAULT_MODEL" help:"Default model for the agent" group:"agents"`
	MultimodalModel       string `env:"NEURODESK_AGENT_POOL_MULTIMODAL_MODEL" help:"Multimodal model for the agent" group:"agents"`
	TranscriptionModel    string `env:"NEURODESK_AGENT_POOL_TRANSCRIPTION_MODEL" help:"Transcription model for the agent" group:"agents"`
	TranscriptionLanguage string `env:"NEURODESK_AGENT_POOL_TRANSCRIPTION_LANGUAGE" help:"Transcription language for the agent" group:"agents"`
	TTSModel              string `env:"NEURODESK_AGENT_POOL_TTS_MODEL" help:"TTS model for the agent" group:"agents"`
	StateDir              string `env:"NEURODESK_AGENT_POOL_STATE_DIR" default:"agents" help:"State directory containing pool.json" type:"path" group:"agents"`
	Timeout               string `env:"NEURODESK_AGENT_POOL_TIMEOUT" default:"5m" help:"Agent timeout" group:"agents"`
	EnableSkills          bool   `env:"NEURODESK_AGENT_POOL_ENABLE_SKILLS" default:"false" help:"Enable skills service" group:"agents"`
	EnableLogs            bool   `env:"NEURODESK_AGENT_POOL_ENABLE_LOGS" default:"false" help:"Enable agent logging" group:"agents"`
	CustomActionsDir      string `env:"NEURODESK_AGENT_POOL_CUSTOM_ACTIONS_DIR" help:"Custom actions directory" group:"agents"`
}
