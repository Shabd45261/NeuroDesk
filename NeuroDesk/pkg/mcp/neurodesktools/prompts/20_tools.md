...
- `list_installed_models` — List models currently installed on this NeuroDesk. Optional `capability` filter (e.g. `chat`, `embed`, `image`).
...
- `system_info` — NeuroDesk version, paths, distributed flag, loaded models, installed backends.
