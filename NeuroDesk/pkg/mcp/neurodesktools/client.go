...
// NeuroDeskClient is the surface tools depend on. It has two implementations:
//
//   - inproc.Client (in-process; calls NeuroDesk services directly)
//   - httpapi.Client (out-of-process; calls the NeuroDesk REST API)
//
...
// rest of NeuroDesk by construction.
type NeuroDeskClient interface {
	// ---- Models / gallery (read) ----
	...
	// neurodesktools.Backend rather than gallery.SystemBackend because the
