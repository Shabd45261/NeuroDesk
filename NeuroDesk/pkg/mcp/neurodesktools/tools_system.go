...
func registerSystemTools(s *mcp.Server, client NeuroDeskClient, opts Options) {
	mcp.AddTool(s, &mcp.Tool{
		Name:        ToolSystemInfo,
		Description: "Report NeuroDesk version, paths, distributed flag, currently loaded models, and installed backends.",
