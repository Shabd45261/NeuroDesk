...
// NeuroDesk admin REST endpoints they wrap. The httpapi.Client MUST hit the
...
// .agents/neurodesk-assistant-mcp.md for the contributor contract.
//
...
var _ = Describe("Tool ↔ HTTP route coverage map", func() {
	...
	// would require booting Application or parsing core/http/routes/neurodesk.go,
