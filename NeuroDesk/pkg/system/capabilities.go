...
const (
	...
	capabilityEnv        = "NEURODESK_FORCE_META_BACKEND_CAPABILITY"
	capabilityRunFileEnv = "NEURODESK_FORCE_META_BACKEND_CAPABILITY_RUN_FILE"
	defaultRunFile       = "/run/neurodesk/capability"
...
// via NEURODESK_FORCE_META_BACKEND_CAPABILITY; the detected "default" has its own
...
// NEURODESK_FORCE_META_BACKEND_CAPABILITY and /run/neurodesk/capability first, and
...
// is disabled via NEURODESK_FORCE_META_BACKEND_CAPABILITY=disable.
...
func (s *SystemState) getSystemCapabilities() string {
	...
	// Check if /run/neurodesk/capability exists and use it
...
// NeuroDesk about a new runtime never means editing logic.
