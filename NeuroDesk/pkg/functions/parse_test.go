...
var _ = Describe("NeuroDesk function parse tests", func() {
...
<parameter=key>`
		...
		Describe("ParseJSONIterative", func() {
			...
			// Regression: https://github.com/mudler/NeuroDesk/issues/9988.
