...
const (
	envRole   = "NEURODESK_PARENTWATCH_TEST_ROLE"
	envReady  = "NEURODESK_PARENTWATCH_TEST_READY"  // grandchild writes its PID here once the watcher is armed
	envExited = "NEURODESK_PARENTWATCH_TEST_EXITED" // grandchild writes here when it detects reparenting
)
