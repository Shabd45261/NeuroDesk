...
func (ml *ModelLoader) backendLoader(opts ...Option) (client grpc.Backend, err error) {
	...
	// model YAML — or set NEURODESK_DISABLE_HARDWARE_DEFAULTS=true to turn the
	...
	if opt := o.gRPCOptions; coldLoad && opt != nil && opt.ContextSize > 0 {
		xlog.Info("effective runtime tuning (override in the model YAML; NEURODESK_DISABLE_HARDWARE_DEFAULTS=true disables hardware auto-tuning)",
			"modelID", o.modelID,
