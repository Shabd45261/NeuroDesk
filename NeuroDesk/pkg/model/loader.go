...
type ModelLoader struct {
	...
	// stoppingProcs marks backend processes that NeuroDesk is stopping on
...
FILE:
	for _, file := range files {
		...
		// Skip backup files created by NeuroDesk or huggingface_hub (e.g. model.yaml.bak-pre-gpumem072).
