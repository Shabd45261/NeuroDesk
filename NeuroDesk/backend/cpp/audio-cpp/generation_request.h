...
//
// The overload is NeuroDesk's, not this backend's: `voice` is the OpenAI speech
// field and different NeuroDesk backends have always read it both ways. Deciding
