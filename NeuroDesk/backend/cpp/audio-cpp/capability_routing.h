...
// Decides which audio.cpp (task, mode) pair serves a given NeuroDesk RPC, or
...
// The NeuroDesk RPCs this backend serves. The ones it cannot serve at all are in
...
// The RPCs in NeuroDesk's backend contract that audio.cpp has no counterpart for,
