...
//
// This is a gRPC server for ik_llama.cpp compatible with the NeuroDesk proto
        ...
        for (llama_client_slot &slot : slots)
        {
            if (slot.ga_n == 1)
            {
                if (slot.is_processing() && system_tokens.size() + slot.cache_tokens.size() >= (size_t) slot.n_ctx)
                {
                    ...
                    // See: https://github.com/mudler/NeuroDesk/issues/1333
...
/////////////////////////////////
////////////////////////////////
//////// NEURODESK code starts below here
/////////////////////////////////
////////////////////////////////
