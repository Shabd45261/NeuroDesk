// privacy-filter NeuroDesk gRPC backend.
//
...
// The engine is single-model-per-process: NeuroDesk spawns one backend process
...
public:
    ...
    GStatus LoadModel(ServerContext *, const backend::ModelOptions * request,
        ...
        // ModelFile is the absolute path NeuroDesk resolves; Model is the bare
