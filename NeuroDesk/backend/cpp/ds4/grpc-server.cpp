// ds4 NeuroDesk gRPC backend.
//
// Wraps antirez/ds4's `ds4_engine_*` / `ds4_session_*` public API
// (see ds4/ds4.h) over NeuroDesk's backend.proto. Tool calls, thinking
...
// readiness probes (they also lock g_engine_mu), making NeuroDesk's loader treat
...
public:
    ...
    GStatus LoadModel(ServerContext *, const backend::ModelOptions *request,
        ...
        // the ds4_layers slice; workers dial in (see `neurodesk worker
