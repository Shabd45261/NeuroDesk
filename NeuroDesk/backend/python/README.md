# Python Backends for NeuroDesk

This directory contains Python-based AI backends for NeuroDesk, providing support for various AI models and hardware acceleration targets.
