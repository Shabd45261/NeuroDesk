#!/usr/bin/env python3
"""
MLX Distributed Inference Backend for NeuroDesk.

Two startup modes:

1. Server mode (started by NeuroDesk automatically):
...
class BackendServicer(backend_pb2_grpc.BackendServicer):
    ...
    When started by NeuroDesk (server mode), distributed init happens at
...
if __name__ == "__main__":
    ...
    parser.add_argument("--addr", default="localhost:50051",
                        help="gRPC listen address (used by NeuroDesk to send requests)")
    ...
    if args.worker:
        ...
        # Server mode: started by NeuroDesk with just --addr.
