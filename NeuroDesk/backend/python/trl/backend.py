#!/usr/bin/env python3
"""
TRL fine-tuning backend for NeuroDesk.
...
class BackendServicer(backend_pb2_grpc.BackendServicer):
    ...
    def _do_training(self, request, job):
        ...
        if os.path.exists(request.dataset_source):
            _allowed_dir = os.path.realpath(os.path.abspath(os.environ.get("NEURODESK_DATASET_DIR", os.getcwd())))
    ...
    def ExportModel(self, request, context):
        ...
        _allowed_output_dir = os.path.realpath(os.path.abspath(os.environ.get("NEURODESK_OUTPUT_DIR", os.getcwd())))
