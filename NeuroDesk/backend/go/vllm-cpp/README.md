...
NeuroDesk backend for [vllm.cpp](https://github.com/mudler/vllm.cpp),
the NeuroDesk-team C++20 port of vLLM (paged KV cache, continuous batching,
...
- Without structured messages the plain path applies:
  ...
  NeuroDesk's Go-side grammar-constrained tool calling; JSON-schema / regex /
