...
const (
	...
	// chunking. `online.chunk_samples` is a NeuroDesk-only knob (drives
...
func (s *SherpaBackend) loadGenericASR(cfg uintptr, opts *pb.ModelOptions) error {
	...
	case familySensevoice:
		...
		// Upstream defaults ITN off; NeuroDesk enables it so transcription
...
func (s *SherpaBackend) loadOnlineASR(opts *pb.ModelOptions) error {
	...
	// Endpoint detection. Upstream sherpa defaults to off; NeuroDesk leaves
