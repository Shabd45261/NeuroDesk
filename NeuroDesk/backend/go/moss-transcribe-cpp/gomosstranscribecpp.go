...
import (
	...
	"github.com/mudler/NeuroDesk/pkg/grpc/base"
	"github.com/mudler/NeuroDesk/pkg/grpc/grpcerrors"
...
// not reentrant, so we embed base.SingleThread — NeuroDesk serialises every RPC
...
// Load is the NeuroDesk gRPC entry point for LoadModel: it calls
...
// "[start][Sxx]text[end]..." format (seconds); we parse it into NeuroDesk
...
// Free releases the underlying moss_transcribe_ctx. Called by NeuroDesk when the
// model is unloaded.
