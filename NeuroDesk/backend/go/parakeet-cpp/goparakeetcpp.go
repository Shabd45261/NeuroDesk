...
// per-word timestamps into a NeuroDesk TranscriptResult.
//
...
// int64 nanoseconds NeuroDesk carries on TranscriptSegment/TranscriptWord, the
...
// Free releases the underlying parakeet_ctx. Called by NeuroDesk when the
// model is unloaded.
