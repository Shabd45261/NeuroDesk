...
// docker all send the equivalent) and rides on requests NeuroDesk already makes.
...
func UserAgent() string {
	...
	if Version == "" {
		return "NeuroDesk " + platform
	}
	return fmt.Sprintf("NeuroDesk/%s %s", Version, platform)
}
