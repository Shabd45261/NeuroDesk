...
const docTemplate = `{
    ...
    "info": {
        ...
        "license": {
            "name": "MIT",
            "url": "https://raw.githubusercontent.com/mudler/NeuroDesk/master/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/neurodesk.AliasInfo"
                            }
                        }
                    }
                }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/neurodesk.BrandingResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/neurodesk.APIInstructionResponse"
                        }
                    },
                    "404": {
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/neurodesk.ModelResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/neurodesk.UpdateMaxReplicasPerModelRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/neurodesk.UpdateVRAMBudgetRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/neurodesk.VoiceProfileListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/neurodesk.GalleryBackend"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/neurodesk.GalleryModel"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "neurodesk.APIInstructionResponse": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "neurodesk.UpdateMaxReplicasPerModelRequest": {
            "type": "object",
            "properties": {
                "value": {
        ...
        "neurodesk.UpdateVRAMBudgetRequest": {
            "type": "object",
            "properties": {
                "value": {
        ...
        "neurodesk.VoiceProfileListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
